define(['highcharts','chart'], function (Highcharts,chart) {
    var ctor = function () {
        ...
        require([
            ...
            //Creating a container for highstock
            ...
            innerDiv.className = 'block-1';

            // The variable iDiv is still good... Just append to it.
            iDiv.appendChild(innerDiv);
            //Creating a container for highchart
    ...
    iDiv3.style.marginTop = '50px';
    document.getElementsByTagName('body')[0].appendChild(iDiv3);

    // Now create and append to iDiv
    var innerDiv3 = document.createElement('div');
    innerDiv3.className = 'block-3';

    // The variable iDiv is still good... Just append to it.
    iDiv3.appendChild(innerDiv3);
    ...
    chart.stockChart('highchart', {
        ...
        title: {
            text: 'Highstock loaded using shim'
        },
        subtitle: {
            text: 'With Annotations and Exporting modules'
        },
        accessibility: {
